...
package seminar.mock_job_for_guess_schema_0_1;
	...
	public void tJavaFlex_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				String url = "jdbc:jtds:sqlserver://PC-CUBI:1433/;";
				java.sql.Connection conn = java.sql.DriverManager
						.getConnection(url, "sa", "CubiTray2018WL");
				...
				java.sql.ResultSet rs = stm
						.executeQuery("select * from stat_raw");
				java.sql.ResultSetMetaData rsmd = rs.getMetaData();
				int numbOfColumn = rsmd.getColumnCount();

				String fileName = (new java.io.File(
						"C:/Program Files (x86)/TOS_DI-20181026_1147-V7.1.1/temp/TempGuessSchemaDelimitedFile.csv"))
		...
		try {
			...
			java.io.InputStream inContext = Mock_job_for_Guess_schema.class
					.getClassLoader().getResourceAsStream(
							"seminar/mock_job_for_guess_schema_0_1/contexts/"
...
/************************************************************************************************
 * 43313 characters generated by Talend Open Studio for Data Integration on the
 * 21 décembre 2018 14:00:39 CET
 ************************************************************************************************/
