...
package seminar.display_file_0_1;
...
public class display_file implements TalendJob {
	...
	private final String jobName = "display_file";
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(display_file.this, new Object[] { e,
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				try {// }
					fid_tFileInputFullRow_1 = new org.talend.fileprocess.FileInputDelimited(
							"C:/SEMINAR_PROJECT/eacc_convention_2018.11.28.json",
							"UTF-8", "", "\n", true, 0, 0, -1, -1, false);
	...
	public static void main(String[] args) {
		final display_file display_fileClass = new display_file();

		int exitCode = display_fileClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = display_file.class.getClassLoader()
					.getResourceAsStream(
							"seminar/display_file_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = display_file.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : display_file");
		}
