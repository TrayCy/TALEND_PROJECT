...
package seminar.replace_files_0_1;
...
/**
 * Job: replace_files Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class replace_files implements TalendJob {
...
public String getDatafolder(){
	...
	private final String jobName = "replace_files";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				replace_files.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(replace_files.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class row2Struct implements routines.system.IPersistableRow<row2Struct> {
    final static byte[] commonByteArrayLock_SEMINAR_replace_files = new byte[0];
    static byte[] commonByteArray_SEMINAR_replace_files = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SEMINAR_replace_files.length) {
				if(length < 1024 && commonByteArray_SEMINAR_replace_files.length == 0) {
   					commonByteArray_SEMINAR_replace_files = new byte[1024];
				} else {
   					commonByteArray_SEMINAR_replace_files = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SEMINAR_replace_files, 0, length);
			strReturn = new String(commonByteArray_SEMINAR_replace_files, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SEMINAR_replace_files) {
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.datafolder + "/temp" + ((String)globalMap.get("tFileList_1_CURRENT_FILE")).substring("eacc".length()))).getAbsolutePath().replace("\\","/");
	...
	currentComponent="tReplace_1";
			...
			//row1
				...
				if(execStat){
                    ...
                    row1.line = StringUtils.replaceAll(row1.line, "\\}\\}", "\\}\\}," + "");                
	        row2.line = row1.line;
 ...
 */
    ...
    public static void main(String[] args){
        final replace_files replace_filesClass = new replace_files();

        int exitCode = replace_filesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = replace_files.class.getClassLoader().getResourceAsStream("seminar/replace_files_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = replace_files.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : replace_files");
        }
...
/************************************************************************************************
 *     47245 characters generated by Talend Open Studio for Data Integration 
 *     on the 14 janvier 2019 22:24:36 CET
 ************************************************************************************************/