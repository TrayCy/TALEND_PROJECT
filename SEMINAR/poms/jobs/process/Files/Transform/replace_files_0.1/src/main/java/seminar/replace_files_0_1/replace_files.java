...
public class replace_files implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(replace_files.this, new Object[] { e,
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SEMINAR_replace_files.length) {
					if (length < 1024
							&& commonByteArray_SEMINAR_replace_files.length == 0) {
				...
				strReturn = new String(commonByteArray_SEMINAR_replace_files,
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File(
						"C:/SEMINAR_PROJECT/files/elasticdump-28.11.2018-11.12.2018/temp_stat_autor_2018.11.28.json"))
				...
				try {// }
					fid_tFileInputFullRow_2 = new org.talend.fileprocess.FileInputDelimited(
							"C:/SEMINAR_PROJECT/files/elasticdump-28.11.2018-11.12.2018/eacc_stat_autor_2018.11.28.json",
							"UTF-8", "", "\n", true, 0, 0, -1, -1, false);
					while (fid_tFileInputFullRow_2.nextRecord()) {// }
						row3 = null;
						boolean whetherReject_tFileInputFullRow_2 = false;
						row3 = new row3Struct();
						row3.line = fid_tFileInputFullRow_2.get(0);
						...
						row3.line = StringUtils.replaceAll(row3.line, "\\}\\}",
								"\\}\\}," + "");
						row4.line = row3.line;
						...
						if (row4.line != null) {
							sb_tFileOutputDelimited_2.append(row4.line);
						}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = replace_files.class
					.getClassLoader().getResourceAsStream(
							"seminar/replace_files_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = replace_files.class
						.getClassLoader()
						.getResourceAsStream(
		...
		} catch (TalendException e_tFileInputFullRow_2) {
			globalMap.put("tFileInputFullRow_2_SUBPROCESS_STATE", -1);

			e_tFileInputFullRow_2.printStackTrace();
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : replace_files");
		}
...
/************************************************************************************************
 * 41089 characters generated by Talend Open Studio for Data Integration on the
 * 19 décembre 2018 00:52:09 CET
 ************************************************************************************************/
