...
public class tab_files implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(tab_files.this, new Object[] { e,
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SEMINAR_tab_files.length) {
					if (length < 1024
							&& commonByteArray_SEMINAR_tab_files.length == 0) {
				...
				strReturn = new String(commonByteArray_SEMINAR_tab_files, 0,
						length, utf8Charset);
			}
			return strReturn;
		}
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				fileName_tFileOutputDelimited_2 = (new java.io.File(
						"C:/SEMINAR_PROJECT/files/elasticdump-28.11.2018-11.12.2018/file_stat_autor_2018.11.28.json"))
				...
				try {
					String content_tFileInputRaw_2 = org.apache.commons.io.FileUtils
							.readFileToString(
									...
									"UTF-8");
					row2.line = content_tFileInputRaw_2;
					globalMap
							.put("tFileInputRaw_2_FILENAME_PATH",
									"C:/SEMINAR_PROJECT/files/elasticdump-28.11.2018-11.12.2018/temp_stat_autor_2018.11.28.json");
				...
				{ // start of Var scope
					...
					copyOfout1_tmp.line = "["
							+ (row2.line)
									.substring(0, (row2.line).length() - 2)
							+ "]";
				...
				if (copyOfout1 != null) {
					...
					if (execStat) {
						runStat.updateStatOnConnection(
								"copyOfout1" + iterateId, 1, 1);
					}

					StringBuilder sb_tFileOutputDelimited_2 = new StringBuilder();
					if (copyOfout1.line != null) {
						sb_tFileOutputDelimited_2.append(copyOfout1.line);
					}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = tab_files.class.getClassLoader()
					.getResourceAsStream(
							"seminar/tab_files_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = tab_files.class
						.getClassLoader()
						.getResourceAsStream(
		...
		} catch (TalendException e_tFileInputRaw_2) {
			globalMap.put("tFileInputRaw_2_SUBPROCESS_STATE", -1);

			e_tFileInputRaw_2.printStackTrace();
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : tab_files");
		}
...
/************************************************************************************************
 * 41906 characters generated by Talend Open Studio for Data Integration on the
 * 19 décembre 2018 00:52:22 CET
 ************************************************************************************************/
