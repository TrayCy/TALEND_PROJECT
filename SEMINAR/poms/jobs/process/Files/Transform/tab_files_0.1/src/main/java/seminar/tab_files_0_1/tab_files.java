...
/**
 * Job: tab_files Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class tab_files implements TalendJob {
...
public String getDatafolder(){
	...
	private final String jobName = "tab_files";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(tab_files.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class out1Struct implements routines.system.IPersistableRow<out1Struct> {
    final static byte[] commonByteArrayLock_SEMINAR_tab_files = new byte[0];
    static byte[] commonByteArray_SEMINAR_tab_files = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_SEMINAR_tab_files.length) {
				if(length < 1024 && commonByteArray_SEMINAR_tab_files.length == 0) {
   					commonByteArray_SEMINAR_tab_files = new byte[1024];
				} else {
   					commonByteArray_SEMINAR_tab_files = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_SEMINAR_tab_files, 0, length);
			strReturn = new String(commonByteArray_SEMINAR_tab_files, 0, length, utf8Charset);
		}
		return strReturn;
	}
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_SEMINAR_tab_files) {
...
out1Struct out1 = new out1Struct();
	 ...
	 */
			...
			int NB_ITERATE_tFileInputRaw_1 = 0; //for statistics
 ...
 */
	NB_ITERATE_tFileInputRaw_1++;
				...
				if(execStat){
					runStat.updateStatOnConnection("iterate1", 1, "exec" + NB_ITERATE_tFileInputRaw_1);
					//Thread.sleep(1000);
				}				
...
String fileName_tFileOutputDelimited_1 = "";
    fileName_tFileOutputDelimited_1 = (new java.io.File(context.datafolder + "/file" + ((String)globalMap.get("tFileList_1_CURRENT_FILE")).substring("temp".length()))).getAbsolutePath().replace("\\","/");
 ...
 */
	...
	currentComponent="tFileInputRaw_1";
		...
		int tos_count_tFileInputRaw_1 = 0;
				...
				try {					
					String content_tFileInputRaw_1 = org.apache.commons.io.FileUtils.readFileToString(new java.io.File(((String)globalMap.get("tFileList_1_CURRENT_FILEPATH"))), "UTF-8");
					row1.line = content_tFileInputRaw_1;					
					globalMap.put("tFileInputRaw_1_FILENAME_PATH", ((String)globalMap.get("tFileList_1_CURRENT_FILEPATH")));
...
// # Output table : 'out1'
out1_tmp.line = "["+(row1.line).substring(0,(row1.line).length()-2)+"]" ;
out1 = out1_tmp;
// ###############################
 ...
 */
						...
						if(execStat){
							runStat.updateStatOnConnection("iterate1", 2, "exec" + NB_ITERATE_tFileInputRaw_1);
						}				
 ...
 */
    ...
    public static void main(String[] args){
        final tab_files tab_filesClass = new tab_files();

        int exitCode = tab_filesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = tab_files.class.getClassLoader().getResourceAsStream("seminar/tab_files_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = tab_files.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : tab_files");
        }
...
/************************************************************************************************
 *     47903 characters generated by Talend Open Studio for Data Integration 
 *     on the 14 janvier 2019 22:24:37 CET
 ************************************************************************************************/