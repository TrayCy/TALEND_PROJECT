...
public class import_stat_raw implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(import_stat_raw.this, new Object[] { e,
	...
	public static class row2Struct implements
		...
		private String readString(ObjectInputStream dis) throws IOException {
			...
			if (length == -1) {
				...
				if (length > commonByteArray_SEMINAR_import_stat_raw.length) {
					if (length < 1024
							&& commonByteArray_SEMINAR_import_stat_raw.length == 0) {
						commonByteArray_SEMINAR_import_stat_raw = new byte[1024];
					} else {
						commonByteArray_SEMINAR_import_stat_raw = new byte[2 * length];
					}
				}
				dis.readFully(commonByteArray_SEMINAR_import_stat_raw, 0,
						length);
				strReturn = new String(commonByteArray_SEMINAR_import_stat_raw,
		...
		public String toString() {
			...
			sb.append(",acquirer_response_code="
					+ String.valueOf(acquirer_response_code));
			sb.append(",acquirer_response_delay="
					+ String.valueOf(acquirer_response_delay));
			sb.append(",timestamp=" + timestamp);
			sb.append(",transaction_id=" + transaction_id);
			sb.append(",service_name=" + service_name);
			sb.append(",target_authorization_center="
					+ String.valueOf(target_authorization_center));
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				for (int i_tFileList_1 = 0; i_tFileList_1 < list_tFileList_1
					...
					final String decryptedPassword_tDBOutput_1 = routines.system.PasswordEncryptUtil
							.decryptPassword("19902c2a02e06304c4a45d7630b6b4c4");

					String dbPwd_tDBOutput_1 = decryptedPassword_tDBOutput_1;
					conn_tDBOutput_1 = java.sql.DriverManager.getConnection(
							url_tDBOutput_1, dbUser_tDBOutput_1,
							dbPwd_tDBOutput_1);
					...
					try {
						filenameOrStream_tFileInputJSON_1 = ((String) globalMap
					...
					try {
						...
						if (result_tFileInputJSON_1 instanceof net.minidev.json.JSONArray) {
							...
							resultset_tFileInputJSON_1
									.add(result_tFileInputJSON_1);
						}
					} catch (java.lang.Exception e_tFileInputJSON_1) {
						System.err.println(e_tFileInputJSON_1.getMessage());
					} finally {
					...
					for (Object row_tFileInputJSON_1 : resultset_tFileInputJSON_1) {
						...
						if (row1 != null) {
							...
							{ // start of Var scope
								...
								row2_tmp.score = row1._score == null ? null
										: Integer.parseInt(row1._score);
								row2_tmp.response_code = row1.response_code == null ? null
										: Integer.parseInt(row1.response_code);
								...
								row2_tmp.merchant_id = row1.merchant_id == null ? null
										: Long.parseLong(row1.merchant_id);
								row2_tmp.client_id = row1.client_id == null ? null
										: Long.parseLong(row1.client_id);
								...
								row2_tmp.date_num = row1.date_num == null ? null
										: Integer.parseInt(row1.date_num);
								row2_tmp.original_amount = row1.original_amount == null ? null
										: Integer
												.parseInt(row1.original_amount);
								row2_tmp.version = row1.source_version == null ? null
										: Integer.parseInt(row1.source_version);
								row2_tmp.host = row1.host;
								row2_tmp.card_iin = row1.card_iin;
								row2_tmp.client_alias = row1.client_alias == null
										|| row1.client_alias
												.equals("%{client_id}") ? null
										: Long.parseLong(row1.client_alias);
								row2_tmp.acquirer_response_code = row1.acquirer_response_code == null ? null
										: Integer
												.parseInt(row1.acquirer_response_code);
								row2_tmp.acquirer_response_delay = row1.acquirer_response_delay == null ? null
										: Integer
												.parseInt(row1.acquirer_response_delay);
								...
								row2_tmp.target_authorization_center = row1.target_authorization_center == null ? null
										: Integer
												.parseInt(row1.target_authorization_center);
								row2_tmp.native_response_code = row1.native_response_code;
								row2_tmp.operation_name = row1.operation_name;
								row2_tmp.merchant_alias = row1.merchant_alias == null
										|| row1.merchant_alias
												.equals("%{merchant_id}") ? null
										: Long.parseLong(row1.merchant_alias);
								...
								row2_tmp.service = row1.source_service == null ? null
										: Integer.parseInt(row1.source_service);
								row2_tmp.merchant_country = row1.merchant_country;
								row2_tmp.csc_indicator = row1.csc_indicator;
								row2_tmp.time = row1.source_time == null ? null
										: Integer.parseInt(row1.source_time);
							...
							if (row2 != null) {
								...
								if (row2.index == null) {
									...
									pstmt_tDBOutput_1.setString(1, row2.index);
								}
								...
								if (row2.type == null) {
									...
									pstmt_tDBOutput_1.setString(2, row2.type);
								}
								...
								if (row2.id == null) {
									...
									pstmt_tDBOutput_1.setString(3, row2.id);
								}
								...
								if (row2.score == null) {
									...
									pstmt_tDBOutput_1.setInt(4, row2.score);
								}
								...
								if (row2.pid == null) {
									...
									pstmt_tDBOutput_1.setString(8, row2.pid);
								}
								...
								if (row2.path == null) {
									...
									pstmt_tDBOutput_1.setString(14, row2.path);
								}
								...
								if (row2.date_num == null) {
									...
									pstmt_tDBOutput_1.setInt(16, row2.date_num);
								}
								...
								if (row2.original_amount == null) {
									...
									pstmt_tDBOutput_1.setInt(17,
											row2.original_amount);
								}
								...
								if (row2.version == null) {
									...
									pstmt_tDBOutput_1.setInt(18, row2.version);
								}
								...
								if (row2.host == null) {
									...
									pstmt_tDBOutput_1.setString(19, row2.host);
								}
								...
								if (row2.acquirer_response_code == null) {
									...
									pstmt_tDBOutput_1.setInt(22,
											row2.acquirer_response_code);
								}
								...
								if (row2.acquirer_response_delay == null) {
									...
									pstmt_tDBOutput_1.setInt(23,
											row2.acquirer_response_delay);
								}
								...
								if (row2.transaction_id == null) {
									...
									pstmt_tDBOutput_1.setString(25,
											row2.transaction_id);
								}
								...
								if (row2.target_authorization_center == null) {
									...
									pstmt_tDBOutput_1.setInt(27,
											row2.target_authorization_center);
								}
								...
								if (row2.timestamp2 == null) {
									...
									pstmt_tDBOutput_1.setString(31,
											row2.timestamp2);
								}
								...
								if (row2.connector == null) {
									...
									pstmt_tDBOutput_1.setString(32,
											row2.connector);
								}
								...
								if (row2.service == null) {
									...
									pstmt_tDBOutput_1.setInt(34, row2.service);
								}
								...
								if (row2.time == null) {
									...
									pstmt_tDBOutput_1.setInt(37, row2.time);
								}
								...
								if (row2.acquirer_response_label == null) {
									...
									pstmt_tDBOutput_1.setString(38,
											row2.acquirer_response_label);
								}
								...
								if (row2.real_authorization_center == null) {
									...
									pstmt_tDBOutput_1.setString(39,
											row2.real_authorization_center);
								}
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = import_stat_raw.class
					.getClassLoader().getResourceAsStream(
							"seminar/import_stat_raw_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = import_stat_raw.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : import_stat_raw");
		}
