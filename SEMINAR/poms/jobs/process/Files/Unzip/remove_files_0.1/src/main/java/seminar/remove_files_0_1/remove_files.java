...
package seminar.remove_files_0_1;
...
/**
 * Job: remove_files Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class remove_files implements TalendJob {
...
public String getDatafolder(){
	...
	private final String jobName = "remove_files";
		...
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(remove_files.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
 ...
 */
    ...
    public static void main(String[] args){
        final remove_files remove_filesClass = new remove_files();

        int exitCode = remove_filesClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = remove_files.class.getClassLoader().getResourceAsStream("seminar/remove_files_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = remove_files.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : remove_files");
        }
...
/************************************************************************************************
 *     31588 characters generated by Talend Open Studio for Data Integration 
