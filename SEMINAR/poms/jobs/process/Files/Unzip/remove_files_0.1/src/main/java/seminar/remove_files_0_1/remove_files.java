...
public class remove_files implements TalendJob {
				...
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(remove_files.this, new Object[] { e,
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = remove_files.class.getClassLoader()
					.getResourceAsStream(
							"seminar/remove_files_0_1/contexts/" + contextStr
									+ ".properties");
			if (inContext == null) {
				inContext = remove_files.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out.println((endUsedMemory - startUsedMemory)
					+ " bytes memory increase when running : remove_files");
		}
...
/************************************************************************************************
 * 31137 characters generated by Talend Open Studio for Data Integration on the
 * 18 décembre 2018 21:05:58 CET
 ************************************************************************************************/
