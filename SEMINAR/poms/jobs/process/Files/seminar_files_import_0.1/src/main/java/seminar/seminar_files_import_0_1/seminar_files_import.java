...
package seminar.seminar_files_import_0_1;
...
/**
 * Job: seminar_files_import Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 7.1.1.20181026_1147
 * @status 
 */
public class seminar_files_import implements TalendJob {
	...
	private final String jobName = "seminar_files_import";
		...
		public void printStackTrace() {
			...
			if (!(e instanceof TDieException)) {
				if (e instanceof TalendException) {
					...
					seminar_files_import.this.exception = e;
				}
			}
			if (!(e instanceof TalendException)) {
				try {
					for (java.lang.reflect.Method m : this.getClass()
						...
						if (m.getName().compareTo(currentComponent + "_error") == 0) {
							m.invoke(seminar_files_import.this, new Object[] {
	...
	public void tRunJob_1Process(final java.util.Map<String, Object> globalMap)
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				paraList_tRunJob_1
						.add("--context=dump12_12_2018_to_17_12_2018");
				...
				parentContextMap_tRunJob_1
						.put("datafolder", context.datafolder);
				paraList_tRunJob_1.add("--context_type " + "datafolder" + "="
						+ "id_String");
				...
				seminar.unzip_files_0_1.unzip_files childJob_tRunJob_1 = new seminar.unzip_files_0_1.unzip_files();
				// pass DataSources
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parentContextMap_tRunJob_5
						.put("datafolder", context.datafolder);
				paraList_tRunJob_5.add("--context_type " + "datafolder" + "="
						+ "id_String");
				...
				seminar.remove_files_0_1.remove_files childJob_tRunJob_5 = new seminar.remove_files_0_1.remove_files();
				// pass DataSources
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parentContextMap_tRunJob_2
						.put("datafolder", context.datafolder);
				paraList_tRunJob_2.add("--context_type " + "datafolder" + "="
						+ "id_String");
				...
				seminar.replace_files_0_1.replace_files childJob_tRunJob_2 = new seminar.replace_files_0_1.replace_files();
				// pass DataSources
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parentContextMap_tRunJob_3
						.put("datafolder", context.datafolder);
				paraList_tRunJob_3.add("--context_type " + "datafolder" + "="
						+ "id_String");
				...
				seminar.tab_files_0_1.tab_files childJob_tRunJob_3 = new seminar.tab_files_0_1.tab_files();
				// pass DataSources
		...
		try {
			...
			if (resumeIt || globalResumeTicket) { // start the resume
				...
				parentContextMap_tRunJob_4
						.put("datafolder", context.datafolder);
				paraList_tRunJob_4.add("--context_type " + "datafolder" + "="
						+ "id_String");
				...
				seminar.import_stat_raw_0_1.import_stat_raw childJob_tRunJob_4 = new seminar.import_stat_raw_0_1.import_stat_raw();
				// pass DataSources
	...
	public String contextStr = "dump18_18_2018_to_15_01_2019";
	...
	public static void main(String[] args) {
		final seminar_files_import seminar_files_importClass = new seminar_files_import();

		int exitCode = seminar_files_importClass.runJobInTOS(args);
	...
	public int runJobInTOS(String[] args) {
		...
		try {
			...
			java.io.InputStream inContext = seminar_files_import.class
					.getClassLoader().getResourceAsStream(
							"seminar/seminar_files_import_0_1/contexts/"
									+ contextStr + ".properties");
			if (inContext == null) {
				inContext = seminar_files_import.class
						.getClassLoader()
						.getResourceAsStream(
		...
		if (false) {
			System.out
					.println((endUsedMemory - startUsedMemory)
							+ " bytes memory increase when running : seminar_files_import");
		}
...
/************************************************************************************************
 * 58976 characters generated by Talend Open Studio for Data Integration on the
 * 25 janvier 2019 20:19:23 CET
 ************************************************************************************************/
